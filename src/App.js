...
class App extends Component {
  ...
  konv_bitcoin(x_bitcoin){
    ...
    var url = 'https://blockchain.info/tobtc?currency=USD&value='+ (x_bitcoin)
    axios.get(url)
    .then((coba_bitcoin)=>{
      console.log(coba_bitcoin.data);
      this.setState({
          
          konv_bitcoin: x_bitcoin+' BTC = Rp. '+(14000/coba_bitcoin.data)
    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">Bitcoin - JC 07</h1>
        </header>
